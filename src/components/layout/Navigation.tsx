    ...
    return (
        <nav className="relative h-full flex justify-between">
            ...
            <div className="flex-1 flex justify-center">
                <nav
                    aria-label="Main"
                    className="relative z-10 max-w-max flex-1 items-center justify-center hidden lg:flex h-full"
                >
                    <div style={{ position: "relative" }}>
                        <ul className="group flex flex-1 list-none items-center justify-center h-full"></ul>
                    </div>
                </nav>
            </div>
